        ...
        return (
          <LineChart data={smoothedMetrics} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
            ...
            <Tooltip
              ...
              formatter={(value: number | undefined, name: string | undefined) => [value?.toFixed(4) ?? "-", name ?? ""]}
            />
            <Legend />
        ...
        return (
          <LineChart data={metrics} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
            ...
            <Tooltip
              contentStyle={{ backgroundColor: "#0a0a0a", border: "1px solid #262626", borderRadius: "8px", fontSize: "12px" }}
              labelStyle={{ color: "#a1a1a1" }}
              formatter={(value: number | undefined) => [value?.toExponential(2) ?? "-", "Learning Rate"]}
            />
        ...
        return (
          <LineChart data={metrics} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
            ...
            <Tooltip
              contentStyle={{ backgroundColor: "#0a0a0a", border: "1px solid #262626", borderRadius: "8px", fontSize: "12px" }}
              labelStyle={{ color: "#a1a1a1" }}
              formatter={(value: number | undefined) => [value ? `${value.toFixed(1)} tok/s` : "-", "Throughput"]}
            />
        ...
        return (
          <LineChart data={metrics} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
            ...
            <Tooltip
              contentStyle={{ backgroundColor: "#0a0a0a", border: "1px solid #262626", borderRadius: "8px", fontSize: "12px" }}
              labelStyle={{ color: "#a1a1a1" }}
              formatter={(value: number | undefined) => [value?.toFixed(4) ?? "-", "Reward"]}
            />
